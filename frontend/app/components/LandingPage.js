...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      {/* Feature Highlights */}
      <section className="py-24 bg-gray-900 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-8">
      ...
      {/* How It Works */}
      <section className="py-24 bg-gray-800 border-b border-gray-700" id="how-it-works">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
      ...
      {/* For Businesses */}
      <section className="py-24 bg-gray-900 border-b border-gray-700" id="for-businesses">
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex items-center">
            <div className="w-1/2">
      ...
      {/* Chicago Map Section */}
      <section className="py-24 bg-gray-800 border-b border-gray-700" id="for-shelters">
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex items-center">
            <div className="w-1/2">
