    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          <span className="text-gray-300">Welcome, {user.name || 'Restaurant'}</span>
          <button 
            onClick={handleLogout}
            className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md transition duration-200 ease-in-out"
          >
            Logout
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 border-b pb-2">Post Leftover Food</h2>
          <form onSubmit={handleSubmit} className="mt-4">
            <div className="mb-4">
              <label className="block text-gray-800 font-medium mb-2">Food Name</label>
              <input
                type="text"
                name="name"
            ...
            <div className="mb-4">
              <label className="block text-gray-800 font-medium mb-2">Quantity</label>
              <input
                type="text"
                name="quantity"
            ...
            <div className="mb-4">
              <label className="block text-gray-800 font-medium mb-2">Expiry Time</label>
              <input
                type="text"
                name="expiryTime"
            ...
            <div className="mb-4">
              <label className="block text-gray-800 font-medium mb-2">Food Image</label>
              <input
                type="file"
                accept="image/*"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-md font-medium shadow-md transition duration-200 ease-in-out"
            >
        ...
        {/* Posted Food Items */}
        <div className="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 border-b pb-2">Your Posted Items</h2>
          
          {foodItems.length === 0 ? (
            <p className="text-gray-700">You haven't posted any food items yet.</p>
          ) : (
            <div className="space-y-4 mt-4">
              {foodItems.map((item) => (
                <div key={item.id} className="border border-gray-200 rounded-md p-4 hover:shadow-md transition duration-200 bg-white">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 text-sm">
                        <p><span className="font-medium text-gray-800">Quantity:</span> <span className="text-gray-800">{item.quantity}</span></p>
                        <p><span className="font-medium text-gray-800">Expires:</span> <span className="text-gray-800">{item.expiryTime}</span></p>
