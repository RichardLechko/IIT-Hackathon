    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {displayLeaderboard.map((entry, index) => (
                  <tr key={entry.id} className={index < 3 ? "bg-green-50" : ""}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className={`text-sm ${index < 3 ? "font-bold" : ""}`}>
                        {index === 0 && <span className="inline-flex items-center justify-center w-6 h-6 bg-yellow-400 text-white rounded-full mr-2">1</span>}
                        {index === 1 && <span className="inline-flex items-center justify-center w-6 h-6 bg-gray-300 text-white rounded-full mr-2">2</span>}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{entry.points.toLocaleString()}</div>
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">How Green Points Work</h2>
          ...
          <p className="text-gray-600">
            Together, our community has saved over <span className="font-bold text-green-600">5,240 kg</span> of food 
